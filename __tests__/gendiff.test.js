...
test.each([
  ...
  expect(genDiff('stylish', pathFirstFile, pathSecondFile)).toEqual(expected);
});
...
test.each([
  ...
  expect(genDiff('plain', pathFirstFile, pathSecondFile)).toEqual(expected);
});
...
test.each([
  ...
  expect(genDiff('json', pathFirstFile, pathSecondFile)).toEqual(expected);
});
